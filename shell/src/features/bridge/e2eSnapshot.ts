...
export function buildE2eShellSnapshot(args: BuildE2eShellSnapshotArgs) {
  ...
  return {
    ...
    controls: {
      ...
      settings_tab_appearance: queryRect(cache, '[data-settings-tab="appearance"]', args.origin),
      settings_tab_default_applications: queryRect(cache, '[data-settings-tab="default-applications"]', args.origin),
      settings_theme_light: queryRect(cache, '[data-settings-theme-mode="light"]', args.origin),
      settings_theme_dark: queryRect(cache, '[data-settings-theme-mode="dark"]', args.origin),
