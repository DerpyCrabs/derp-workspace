...
} as Record<Exclude<ThemePalette, 'gray'>, Record<'light' | 'dark', ThemeTokenMap>> &
  Partial<Record<ThemePalette, Record<'light' | 'dark', ThemeTokenMap>>>

THEMES.gray = {
  dark: {
    'shell-text': 'hsl(0 0% 92%)',
    'shell-text-muted': 'hsl(0 0% 74%)',
    'shell-text-dim': 'hsl(0 0% 56%)',
    'shell-text-strong': 'hsl(0 0% 84%)',
    'shell-text-mono': 'hsl(0 0% 78%)',
    'shell-border': 'hsl(0 0% 24% / 0.78)',
    'shell-border-strong': 'hsl(0 0% 34% / 0.9)',
    'shell-bg': 'hsl(0 0% 8% / 0.96)',
    'shell-surface': 'hsl(0 0% 14% / 0.88)',
    'shell-surface-solid': 'hsl(0 0% 14%)',
    'shell-surface-panel': 'hsl(0 0% 12% / 0.95)',
    'shell-surface-elevated': 'hsl(0 0% 18% / 0.94)',
    'shell-surface-inset': 'hsl(0 0% 10% / 0.92)',
    'shell-surface-hover': 'hsl(0 0% 21% / 0.96)',
    'shell-taskbar-bg': 'hsl(0 0% 11% / 0.98)',
    'shell-taskbar-bg-solid': 'hsl(0 0% 11%)',
    'shell-taskbar-focus-indicator': 'hsl(0 0% 72%)',
    'shell-accent': 'hsl(0 0% 68%)',
    'shell-accent-hover': 'hsl(0 0% 78%)',
    'shell-accent-foreground': 'hsl(0 0% 10%)',
    'shell-accent-border': 'hsl(0 0% 58% / 0.82)',
    'shell-accent-soft': 'hsl(0 0% 30% / 0.44)',
    'shell-accent-soft-border': 'hsl(0 0% 46% / 0.58)',
    'shell-accent-soft-text': 'hsl(0 0% 86%)',
    'shell-control-muted-bg': 'hsl(0 0% 18% / 0.95)',
    'shell-control-muted-hover': 'hsl(0 0% 25% / 0.95)',
    'shell-control-muted-text': 'hsl(0 0% 86%)',
    'shell-input-bg': 'hsl(0 0% 11% / 0.96)',
    'shell-input-border': 'hsl(0 0% 28% / 0.9)',
    'shell-input-focus': 'hsl(0 0% 54%)',
    'shell-overlay': 'hsl(0 0% 13% / 0.98)',
    'shell-overlay-border': 'hsl(0 0% 8% / 0.78)',
    'shell-overlay-hover': 'hsl(0 0% 21% / 0.94)',
    'shell-overlay-active': 'hsl(0 0% 27% / 0.94)',
    'shell-overlay-muted': 'hsl(0 0% 46% / 0.18)',
    'shell-warning-bg': 'hsl(0 0% 18% / 0.94)',
    'shell-warning-border': 'hsl(0 0% 42% / 0.36)',
    'shell-warning-text': 'hsl(0 0% 86%)',
    'shell-preview-outline': 'hsl(0 0% 66% / 0.68)',
    'shell-preview-shadow': 'rgba(160, 160, 160, 0.14)',
    'shell-display-preview-bg': 'hsl(0 0% 10% / 0.97)',
    'shell-display-preview-glow': 'radial-gradient(circle at top, rgba(160, 160, 160, 0.14), transparent 58%)',
    'shell-display-card-bg': 'linear-gradient(180deg, rgba(50, 50, 50, 0.96), rgba(34, 34, 34, 0.98))',
    'shell-display-card-border': 'hsl(0 0% 34% / 0.86)',
    'shell-display-card-primary-bg': 'linear-gradient(180deg, rgba(132, 132, 132, 0.72), rgba(82, 82, 82, 0.82))',
    'shell-display-card-primary-border': 'hsl(0 0% 64% / 0.7)',
    'shell-window-chrome-focused': 'hsl(0 0% 22%)',
    'shell-window-chrome-unfocused': 'hsl(0 0% 14%)',
    'shell-cursor-readout': 'hsl(0 0% 68%)',
    'shell-crosshair': 'hsl(0 0% 64% / 0.74)',
    'shell-scrollbar-track': 'hsl(0 0% 11% / 0.96)',
    'shell-scrollbar-thumb': 'hsl(0 0% 30% / 0.95)',
    'shell-scrollbar-thumb-hover': 'hsl(0 0% 42% / 0.98)',
  },
  light: {
    'shell-text': 'hsl(0 0% 14%)',
    'shell-text-muted': 'hsl(0 0% 33%)',
    'shell-text-dim': 'hsl(0 0% 48%)',
    'shell-text-strong': 'hsl(0 0% 22%)',
    'shell-text-mono': 'hsl(0 0% 28%)',
    'shell-border': 'hsl(0 0% 78% / 0.9)',
    'shell-border-strong': 'hsl(0 0% 68% / 0.95)',
    'shell-bg': 'hsl(0 0% 96% / 0.96)',
    'shell-surface': 'hsl(0 0% 99% / 0.9)',
    'shell-surface-solid': 'hsl(0 0% 99%)',
    'shell-surface-panel': 'hsl(0 0% 96% / 0.97)',
    'shell-surface-elevated': 'hsl(0 0% 100% / 0.98)',
    'shell-surface-inset': 'hsl(0 0% 92% / 0.94)',
    'shell-surface-hover': 'hsl(0 0% 94% / 0.98)',
    'shell-taskbar-bg': 'hsl(0 0% 94% / 0.97)',
    'shell-taskbar-bg-solid': 'hsl(0 0% 94%)',
    'shell-taskbar-focus-indicator': 'hsl(0 0% 38%)',
    'shell-accent': 'hsl(0 0% 42%)',
    'shell-accent-hover': 'hsl(0 0% 34%)',
    'shell-accent-foreground': 'hsl(0 0% 100%)',
    'shell-accent-border': 'hsl(0 0% 34% / 0.74)',
    'shell-accent-soft': 'hsl(0 0% 50% / 0.16)',
    'shell-accent-soft-border': 'hsl(0 0% 45% / 0.3)',
    'shell-accent-soft-text': 'hsl(0 0% 28%)',
    'shell-control-muted-bg': 'hsl(0 0% 100% / 0.9)',
    'shell-control-muted-hover': 'hsl(0 0% 90% / 0.98)',
    'shell-control-muted-text': 'hsl(0 0% 20%)',
    'shell-input-bg': 'hsl(0 0% 100% / 0.96)',
    'shell-input-border': 'hsl(0 0% 78% / 0.92)',
    'shell-input-focus': 'hsl(0 0% 42%)',
    'shell-overlay': 'hsl(0 0% 99% / 0.98)',
    'shell-overlay-border': 'hsl(0 0% 78% / 0.9)',
    'shell-overlay-hover': 'hsl(0 0% 92% / 0.96)',
    'shell-overlay-active': 'hsl(0 0% 84% / 0.98)',
    'shell-overlay-muted': 'hsl(0 0% 50% / 0.14)',
    'shell-warning-bg': 'hsl(0 0% 94%)',
    'shell-warning-border': 'hsl(0 0% 68% / 0.72)',
    'shell-warning-text': 'hsl(0 0% 28%)',
    'shell-preview-outline': 'hsl(0 0% 44% / 0.72)',
    'shell-preview-shadow': 'rgba(90, 90, 90, 0.16)',
    'shell-display-preview-bg': 'hsl(0 0% 95% / 0.96)',
    'shell-display-preview-glow': 'radial-gradient(circle at top, rgba(120, 120, 120, 0.14), transparent 58%)',
    'shell-display-card-bg': 'linear-gradient(180deg, rgba(252, 252, 252, 0.98), rgba(230, 230, 230, 0.99))',
    'shell-display-card-border': 'hsl(0 0% 72% / 0.88)',
    'shell-display-card-primary-bg': 'linear-gradient(180deg, rgba(120, 120, 120, 0.9), rgba(82, 82, 82, 0.94))',
    'shell-display-card-primary-border': 'hsl(0 0% 44% / 0.72)',
    'shell-window-chrome-focused': 'hsl(0 0% 88%)',
    'shell-window-chrome-unfocused': 'hsl(0 0% 83%)',
    'shell-cursor-readout': 'hsl(0 0% 34%)',
    'shell-crosshair': 'hsl(0 0% 36% / 0.78)',
    'shell-scrollbar-track': 'hsl(0 0% 92% / 0.96)',
    'shell-scrollbar-thumb': 'hsl(0 0% 70% / 0.95)',
    'shell-scrollbar-thumb-hover': 'hsl(0 0% 56% / 0.98)',
  },
}
