...
const THEMES: Record<ThemePalette, Record<'light' | 'dark', ThemeTokenMap>> = {
  default: {
    dark: {
      ...
      'shell-taskbar-bg-solid': 'hsl(220 20% 11%)',
      'shell-taskbar-focus-indicator': 'hsl(214 18% 56%)',
    ...
    light: {
      ...
      'shell-taskbar-bg-solid': 'hsl(210 36% 95%)',
      'shell-taskbar-focus-indicator': 'hsl(213 42% 52%)',
  ...
  caffeine: {
    dark: {
      ...
      'shell-taskbar-bg-solid': 'hsl(23 20% 11%)',
      'shell-taskbar-focus-indicator': 'hsl(32 58% 68%)',
    ...
    light: {
      ...
      'shell-taskbar-bg-solid': 'hsl(37 44% 94%)',
      'shell-taskbar-focus-indicator': 'hsl(31 62% 52%)',
  ...
  'cosmic-night': {
    dark: {
      ...
      'shell-taskbar-bg-solid': 'hsl(249 30% 11%)',
      'shell-taskbar-focus-indicator': 'hsl(274 72% 72%)',
    ...
    light: {
      ...
      'shell-taskbar-bg-solid': 'hsl(258 50% 95%)',
      'shell-taskbar-focus-indicator': 'hsl(271 72% 56%)',
