...
pub(crate) struct FileBrowserFixturePaths {
    ...
    pub markdown_with_image: String,
    pub read_only_markdown: String,
...
fn collect_fixture_paths(
    ...
    Ok(FileBrowserFixturePaths {
        ...
        markdown_with_image: required("markdown_with_image")?,
        read_only_markdown: required("read_only_markdown")?,
