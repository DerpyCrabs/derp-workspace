...
pub const SHELL_SNAPSHOT_DOMAIN_FOCUS: u32 = 1 << 2;
pub const SHELL_SNAPSHOT_DOMAIN_KEYBOARD: u32 = 1 << 3;
pub const SHELL_SNAPSHOT_DOMAIN_WORKSPACE: u32 = 1 << 4;
pub const SHELL_SNAPSHOT_DOMAIN_SHELL_HOSTED_APPS: u32 = 1 << 5;
