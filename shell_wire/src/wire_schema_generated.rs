...
pub const SHELL_WIRE_MESSAGE_VALUES: &[u32] = &[MSG_SPAWN_WAYLAND_CLIENT, MSG_COMPOSITOR_POINTER_MOVE, MSG_COMPOSITOR_POINTER_BUTTON, MSG_OUTPUT_GEOMETRY, MSG_WINDOW_MAPPED, MSG_WINDOW_UNMAPPED, MSG_WINDOW_GEOMETRY, MSG_WINDOW_METADATA, MSG_FOCUS_CHANGED, MSG_WINDOW_LIST, MSG_SHELL_MOVE_BEGIN, MSG_SHELL_MOVE_DELTA, MSG_SHELL_MOVE_END, MSG_SHELL_LIST_WINDOWS, MSG_SHELL_SET_GEOMETRY, MSG_SHELL_CLOSE, MSG_SHELL_SET_FULLSCREEN, MSG_SHELL_QUIT_COMPOSITOR, MSG_COMPOSITOR_TOUCH, MSG_FRAME_DMABUF_COMMIT, MSG_COMPOSITOR_POINTER_AXIS, MSG_COMPOSITOR_KEY, MSG_SHELL_TASKBAR_ACTIVATE, MSG_WINDOW_STATE, MSG_SHELL_MINIMIZE, MSG_SHELL_RESIZE_BEGIN, MSG_SHELL_RESIZE_DELTA, MSG_SHELL_RESIZE_END, MSG_SHELL_SET_MAXIMIZED, MSG_SHELL_SET_PRESENTATION_FULLSCREEN, MSG_OUTPUT_LAYOUT, MSG_SHELL_SET_OUTPUT_LAYOUT, MSG_SHELL_CONTEXT_MENU, MSG_COMPOSITOR_CONTEXT_MENU_DISMISS, MSG_SHELL_TILE_PREVIEW, MSG_SHELL_CHROME_METRICS, MSG_COMPOSITOR_PROGRAMS_MENU_TOGGLE, MSG_COMPOSITOR_KEYBIND, MSG_COMPOSITOR_KEYBOARD_LAYOUT, MSG_COMPOSITOR_VOLUME_OVERLAY, MSG_SHELL_WINDOWS_SYNC, MSG_COMPOSITOR_TRAY_HINTS, MSG_COMPOSITOR_TRAY_SNI, MSG_COMPOSITOR_WORKSPACE_STATE, MSG_SHELL_WORKSPACE_MUTATION, MSG_COMPOSITOR_SHELL_HOSTED_APP_STATE, MSG_COMPOSITOR_INTERACTION_STATE, MSG_COMPOSITOR_NATIVE_DRAG_PREVIEW, MSG_COMPOSITOR_WORKSPACE_STATE_BINARY, MSG_WINDOW_ORDER, MSG_COMPOSITOR_COMMAND_PALETTE_STATE];
pub const SHELL_SNAPSHOT_DOMAIN_VALUES: &[u32] = &[SHELL_SNAPSHOT_DOMAIN_OUTPUTS, SHELL_SNAPSHOT_DOMAIN_WINDOWS, SHELL_SNAPSHOT_DOMAIN_FOCUS, SHELL_SNAPSHOT_DOMAIN_KEYBOARD, SHELL_SNAPSHOT_DOMAIN_WORKSPACE, SHELL_SNAPSHOT_DOMAIN_SHELL_HOSTED_APPS, SHELL_SNAPSHOT_DOMAIN_INTERACTION, SHELL_SNAPSHOT_DOMAIN_NATIVE_DRAG_PREVIEW, SHELL_SNAPSHOT_DOMAIN_TRAY, SHELL_SNAPSHOT_DOMAIN_WINDOW_ORDER, SHELL_SNAPSHOT_DOMAIN_WINDOW_GEOMETRY, SHELL_SNAPSHOT_DOMAIN_WINDOW_METADATA, SHELL_SNAPSHOT_DOMAIN_WINDOW_STATE, SHELL_SNAPSHOT_DOMAIN_COMMAND_PALETTE];
pub const HOT_BATCH_TAG_VALUES: &[u8] = &[HOT_DETAIL_WINDOW_GEOMETRY, HOT_DETAIL_WINDOW_STATE, HOT_DETAIL_WINDOW_UNMAPPED, HOT_DETAIL_FOCUS_CHANGED, HOT_DETAIL_WINDOW_ORDER, HOT_DETAIL_INTERACTION_STATE];
pub const SHELL_SHARED_STATE_KIND_VALUES: &[u32] = &[SHELL_SHARED_STATE_KIND_EXCLUSION_ZONES, SHELL_SHARED_STATE_KIND_UI_WINDOWS, SHELL_SHARED_STATE_KIND_FLOATING_LAYERS];
